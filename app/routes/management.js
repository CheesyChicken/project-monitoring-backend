...
router.get('/tablemanagement', (req, res, next) => {
    ...
    var sql = "select a.* ,b1.FullName,t1.Project_Type_Name as Type,i1.Company_name as company, b2.FullName as guide2,c1.College_Name as clg,s1.Status_Name as Status ,dd1.Department_Name,d1.Domain_Name as dom1,d2.Domain_Name as dom2,d3.Domain_Name as dom3,d4.Domain_Name as dom4 from project_group a Join department dd1 on dd1.Department_id=a.Department_id  JOIN persons b1 on b1.Person_id=a.Instructor_id1 Join persons b2 on b2.Person_id =a.Instructor_id2 Join college c1 on c1.College_id=a.College_id Join project_domain d1 on d1.Domain_id=a.Domain_Pref_1 Join project_domain d2 on d2.Domain_id=a.Domain_Pref_2 Join project_domain d3 on d3.Domain_id=a.Domain_Pref_3 Join project_domain d4 on d4.Domain_id=a.final_domain Join project_type t1 on t1.Project_Type_id=a.Project_Type_id join company i1 on i1.Company_id= (select Company_id from industryproject ip where ip.industry_project_id=a.industry_project_id) Join status s1 on s1.Status_id=a.Status_id"
